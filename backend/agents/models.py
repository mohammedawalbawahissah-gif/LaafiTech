...
class Agent(models.Model):
    ...
    gps_home_lat = models.DecimalField(max_digits=6, decimal_places=5, blank=True, null=True)
    gps_home_lng = models.DecimalField(max_digits=6, decimal_places=5, blank=True, null=True)
